 ...
 * 
 *  Matrix containing 30 reference/measurement vectors of size 3 for first 30 nodes.
 */
real_t y[ 90 ];
...
/** Matrix of size: 270 x 3 (row major format) */
real_t evGu[ 810 ];
...
/** Matrix of size: 4185 x 3 (row major format) */
real_t E[ 12555 ];
...
/** Matrix of size: 60 x 90 (row major format) */
real_t A[ 5400 ];
