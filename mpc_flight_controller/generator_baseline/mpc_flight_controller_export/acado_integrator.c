...
/* Compute outputs: */
out[0] = (xd[0]+((real_t)(6.6666666666666666e-02)*xd[3]));
out[1] = (xd[1]+((real_t)(6.6666666666666666e-02)*xd[4]));
out[2] = (((xd[2]+((real_t)(1.0672486585754219e+00)*xd[5]))-((real_t)(1.0049332724894500e-01)*xd[6]))+((real_t)(1.9197303582300001e-03)*u[2]));
out[3] = (((real_t)(9.8780826220014994e-01)*xd[3])+(((a[0]/a[1])*(real_t)(9.8066501617431641e+00))*(real_t)(6.6666666666666666e-02)));
out[4] = (((real_t)(9.8670911430742803e-01)*xd[4])-((a[2]*(real_t)(9.8066501617431641e+00))*(real_t)(6.6666666666666666e-02)));
...
out[3] = (real_t)(6.6666666666666666e-02);
...
out[20] = (real_t)(6.6666666666666666e-02);
...
out[55] = ((((real_t)(0.0000000000000000e+00)-((a[0]*a[1])*a[4]))*(real_t)(9.8066501617431641e+00))*(real_t)(6.6666666666666666e-02));
out[56] = (((a[5]*a[3])*(real_t)(9.8066501617431641e+00))*(real_t)(6.6666666666666666e-02));
...
out[71] = ((real_t)(0.0000000000000000e+00)-((a[6]*(real_t)(9.8066501617431641e+00))*(real_t)(6.6666666666666666e-02)));
