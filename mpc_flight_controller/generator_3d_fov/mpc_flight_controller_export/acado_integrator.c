...
/* Compute outputs: */
out[0] = (xd[0]+((real_t)(1.0000000000000001e-01)*xd[3]));
out[1] = (xd[1]+((real_t)(1.0000000000000001e-01)*xd[4]));
out[2] = (((xd[2]+((real_t)(1.0672486585754219e+00)*xd[5]))-((real_t)(1.0049332724894500e-01)*xd[6]))+((real_t)(1.9197303582300001e-03)*u[2]));
out[3] = (((real_t)(9.8780826220014994e-01)*xd[3])+(((a[0]/a[1])*(real_t)(9.8066501617431641e+00))*(real_t)(1.0000000000000001e-01)));
out[4] = (((real_t)(9.8670911430742803e-01)*xd[4])-((a[2]*(real_t)(9.8066501617431641e+00))*(real_t)(1.0000000000000001e-01)));
...
out[24] = (real_t)(1.0000000000000001e-01);
...
out[67] = ((((real_t)(0.0000000000000000e+00)-((a[0]*a[1])*a[4]))*(real_t)(9.8066501617431641e+00))*(real_t)(1.0000000000000001e-01));
out[68] = (((a[5]*a[3])*(real_t)(9.8066501617431641e+00))*(real_t)(1.0000000000000001e-01));
...
out[87] = ((real_t)(0.0000000000000000e+00)-((a[6]*(real_t)(9.8066501617431641e+00))*(real_t)(1.0000000000000001e-01)));
...
out[147] = (real_t)(6.0657452197261597e-01);
...
out[154] = (real_t)(3.6197489307367903e-01);
...
out[168] = (real_t)(5.9102501204030700e-01);
...
out[175] = (real_t)(3.7750910669390098e-01);
...
acadoWorkspace.rk_xxx[30] = rk_eta[310];
acadoWorkspace.rk_xxx[31] = rk_eta[311];
acadoWorkspace.rk_xxx[32] = rk_eta[312];
acadoWorkspace.rk_xxx[33] = rk_eta[313];
acadoWorkspace.rk_xxx[34] = rk_eta[314];
acadoWorkspace.rk_xxx[35] = rk_eta[315];
acadoWorkspace.rk_xxx[36] = rk_eta[316];
acadoWorkspace.rk_xxx[37] = rk_eta[317];
acadoWorkspace.rk_xxx[38] = rk_eta[318];
acadoWorkspace.rk_xxx[39] = rk_eta[319];
acadoWorkspace.rk_xxx[40] = rk_eta[320];
acadoWorkspace.rk_xxx[41] = rk_eta[321];
acadoWorkspace.rk_xxx[42] = rk_eta[322];
acadoWorkspace.rk_xxx[43] = rk_eta[323];
acadoWorkspace.rk_xxx[44] = rk_eta[324];
acadoWorkspace.rk_xxx[45] = rk_eta[325];
acadoWorkspace.rk_xxx[46] = rk_eta[326];
acadoWorkspace.rk_xxx[47] = rk_eta[327];
acadoWorkspace.rk_xxx[48] = rk_eta[328];
acadoWorkspace.rk_xxx[49] = rk_eta[329];
