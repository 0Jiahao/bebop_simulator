...
/** Matrix of size: 26 x 30 (row major format)
 * 
 ...
 * 
 *  Matrix containing 25 reference/measurement vectors of size 7 for first 25 nodes.
 */
real_t y[ 175 ];
...
/** Column vector of size: 226 */
real_t conAuxVar[ 226 ];

/** Row vector of size: 50 */
real_t conValueIn[ 50 ];

/** Row vector of size: 126 */
real_t conValueOut[ 126 ];
