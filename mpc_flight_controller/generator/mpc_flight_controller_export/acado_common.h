...
/** Matrix of size: 280 x 6 (row major format) */
real_t evGu[ 1680 ];
...
/** Matrix of size: 40 x 14 (row major format) */
real_t evHx[ 560 ];
...
/** Matrix of size: 2940 x 6 (row major format) */
real_t E[ 17640 ];
...
/** Matrix of size: 40 x 120 (row major format) */
real_t A[ 4800 ];
