...
{
int dummy;
/** Matrix of size: 26 x 12 (row major format)
 * 
...
/** Matrix of size: 26 x 39 (row major format)
 * 
 ...
 * 
 *  Matrix containing 25 reference/measurement vectors of size 4 for first 25 nodes.
 */
real_t y[ 100 ];
...
/** Matrix of size: 300 x 12 (row major format) */
real_t evGx[ 3600 ];
...
/** Column vector of size: 382 */
real_t conAuxVar[ 382 ];
...
/** Matrix of size: 3900 x 4 (row major format) */
real_t E[ 15600 ];
...
/** Matrix of size: 150 x 100 (row major format) */
real_t A[ 15000 ];
